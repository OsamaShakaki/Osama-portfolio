...
const SplineScene = dynamic(() => import('@/components/ui/SplineScene').then(mod => ({ default: mod.SplineScene })), {
    ssr: false,
    loading: () => <div className="h-full w-full bg-slate-900/10 dark:bg-zinc-800/10 animate-pulse rounded-2xl" />
});

const KineticTechGrid = dynamic(() => import('@/components/ui/KineticTechGrid').then(mod => ({ default: mod.KineticTechGrid })), { ssr: true });
const ArchedTechIconsInteractive = dynamic(() => import('@/components/ui/ArchedTechIcons').then(mod => ({ default: mod.ArchedTechIconsInteractive })), { ssr: true });
const HorizontalScrollCarousel = dynamic(() => import('@/components/ui/horizontal-scroll-carousel').then(mod => ({ default: mod.HorizontalScrollCarousel })), { ssr: true });
const HardSkills = dynamic(() => import('@/components/sections/skills/HardSkills').then(mod => ({ default: mod.HardSkills })), { ssr: true });
const ToolsSection = dynamic(() => import('@/components/sections/skills/ToolsSection').then(mod => ({ default: mod.ToolsSection })), { ssr: true });
