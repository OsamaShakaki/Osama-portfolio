...
import { Github, Twitter, Youtube, Linkedin, Instagram, X, Phone } from "lucide-react";
...
export function ProfileCard(props: ProfileCardProps) {
  ...
  const socialIcons = [
    ...
    { icon: XIcon, url: twitterUrl, label: "X" },
    { icon: Phone, url: phoneUrl, label: "Phone" },
  ].filter(social => social.url !== "#" && social.url !== undefined && social.url !== "");
  ...
  return (
    <div className={cn("w-full max-w-7xl mx-auto px-4 relative", className)}>
      ...
      <div className='hidden md:flex relative items-center'>
        {/* Square Image */}
        <div className='w-[480px] h-[480px] rounded-[2.5rem] overflow-hidden bg-gray-200 dark:bg-gray-800 flex-shrink-0 shadow-2xl relative z-0 group/img'>
          <Image
            src={imageUrl}
            alt={name}
            width={480}
        ...
        >
          ...
          <p className='text-zinc-600 dark:text-zinc-400 text-base leading-relaxed mb-10 text-justify'>
            {description}
          </p>
      ...
      >
        {/* Square Mobile Image */}
        <div className='w-full aspect-square bg-gray-200 dark:bg-gray-700 rounded-3xl overflow-hidden mb-6 flex items-center justify-center group/img'>
          <Image
            src={imageUrl}
            alt={name}
            width={400}
        ...
        <div className='px-4'>
          ...
          <p className='text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed mb-6 text-justify'>
            {description}
          </p>
