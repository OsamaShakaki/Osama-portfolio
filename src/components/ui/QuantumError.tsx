...
export function QuantumError({ type = '404', reset }: QuantumErrorProps) {
    ...
    const description = type === '404'
        ? "The page you're looking for is missing. Don't worry, Osama is already tracking it down (and scanning the neural networks)."
        : "A wild exception was caught! Osama is currently wrestling with the server to rewrite reality (or at least the code). Hang tight!";
